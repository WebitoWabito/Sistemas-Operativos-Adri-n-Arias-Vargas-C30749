/**
  *   C++ program to send messages to a mailbox, using normal Unix interface
  *
  *   UCR-ECCI
  *
  *   CI0122 Sistemas Operativos 2026-i
  *
  *   envialSinClases.c  (direct system call to message passing)
  *
 **/
...
/*
// Do not delete mailbox, to allow other program to receive its messages
