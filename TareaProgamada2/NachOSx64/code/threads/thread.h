...
// while executing kernel code.
  ...
  public:
    ...
    bool ownsSpace;             // true si este hilo debe liberar el AddrSpace al terminar

    Semaphore *joinSemaphore;   // Semaforo para que join espere la terminacion
    int exitStatus;             // Valor de retorno del Exit
#endif
};
